...
<template>
    <Head title="Nueva Contraseña - ProDoctor" />
    ...
    <div class="relative min-h-screen bg-[#040A18] flex flex-col items-center justify-center p-6 overflow-hidden select-none font-sans text-slate-300">
        ...
        <div class="relative w-full max-w-md bg-[#07111e] border border-[#13283f] rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.6)] p-8 z-10">
            ...
            <div class="text-center mb-6 flex flex-col items-center">
                ...
                <h1 class="text-2xl font-bold text-white tracking-tight">Nueva Contraseña</h1>
            ...
            <div class="mb-6 text-xs text-slate-400 text-center leading-relaxed">
                Ingresa y confirma tu nueva contraseña de acceso para la cuenta <span class="text-[#00dfb2] font-semibold">{{ email }}</span>.
            </div>

            <form @submit.prevent="submit" class="space-y-5">
                <!-- Input Nueva Contraseña con Icono y Toggle de Visibilidad -->
                <div class="space-y-1.5">
                    <label for="password" class="text-[10px] font-bold text-[#00dfb2] uppercase tracking-widest block">Nueva Contraseña</label>
                    <div class="relative">
                ...
                <!-- Input Confirmar Contraseña con Icono y Toggle de Visibilidad -->
                <div class="space-y-1.5">
                    <label for="password_confirmation" class="text-[10px] font-bold text-[#00dfb2] uppercase tracking-widest block">Confirmar Contraseña</label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-slate-500">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 10-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H6.75a2.25 2.25 0 00-2.25 2.25v6.75a2.25 2.25 0 002.25 2.25z" />
                    ...
                    <span v-if="form.errors.password_confirmation" class="text-xs text-rose-500 font-medium block mt-1">{{ form.errors.password_confirmation }}</span>
                </div>
